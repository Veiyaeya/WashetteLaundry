...
<body>
  ...
  <div class="header d-flex align-items-center justify-content-between rounded-4 mb-4">
    ...
    <div class="d-flex align-items-center position-relative" style="gap: 8px; margin-right: 8px;">
      ...
      <div id="profileMenu" class="profile-menu">
          <a href="/washette/fpasswordAdmin.php" class="nav-link">Change Password</a>
  ...
  <!-- Recent Orders -->
<div class="card p-2 mb-4 no-hover-effect" style="min-height: 60vh;"> <!-- Changed p-3 to p-2 -->
    <div class="card-body">
        <div class="card-body">
            ...
            <div class="orders table-responsive" style="padding: 0; margin: 0;"> <!-- Removed default padding/margin -->
              <table class="transaction-table align-middle" id="ordersTable">
                ...
                <tbody>
                  ...
                  <?php
                  $transactions = $con->getRecentTransactions();
...
<style>
        ...
        <div class="modal-body">
          <form id="filterForm">
            <div class="form-check mb-2">
              <input class="form-check-input status-checkbox" type="checkbox" value="Completed" id="statusCompleted"
                checked />
              <span class="custom-checkmark"></span>
              <label class="form-check-label" for="statusCompleted" style="color: #395c58">Completed</label>
            </div>
            <div class="form-check mb-2">
              <input class="form-check-input status-checkbox" type="checkbox" value="Cancelled" id="statusCancelled"
                checked />
              <span class="custom-checkmark"></span>
              <label class="form-check-label" for="statusCancelled" style="color: #395c58">Cancelled</label>
            </div>
            <div class="form-check mb-2">
              <input class="form-check-input status-checkbox" type="checkbox" value="In Progress" id="statusInProgress"
                checked />
              <span class="custom-checkmark"></span>
            ...
            <div class="row g-3">
              ...
              foreach ($services as $service) {
                ...
                <div class="col-6 col-lg-4">
                  <div class="service-card p-3 text-center h-100 rounded-3" style="background-color: rgba(225, 243, 242, 0.27) !important;
 ...
 border: 1.5px solid #bfe6e3">
          ...
          <form id="profileForm">
            <div class="mb-3 d-flex flex-column align-items-center">
              <div class="profile-picture-wrapper" style="position: relative">
                <img id="profileIconModal" src="/img/profile.png" alt="Profile" class="profile-picture" style="
                      width: 70px;
                      height: 70px;
                      border-radius: 50%;
                      object-fit: cover;
  ...
  <script>
    ...
    // Save password change functionality
    document.getElementById('saveProfileBtn').addEventListener('click', function(e) {
      ...
      fetch('../update_password.php', {
        ...
        body: `adminID=<?php echo $_SESSION['adminID']; ?>&newPassword=${encodeURIComponent(newPassword)}`
      })
