...
if (isset($_SESSION['CustomerID'])) {
    // If logged in as customer, redirect to customer home page
    ...
    if ($_POST['password'] !== $_POST['confpassword']) {
        ...
        if ($userID) {
            ...
            Swal.fire({
              ...
              text: 'You have successfully registered a new admin. Please log in to continue.',
              confirmButtonText: 'OK'
            }).then(() => {
              window.location.href = '/washette/loginAdmin.php';
            });
            </script>
            ";
        } else {
